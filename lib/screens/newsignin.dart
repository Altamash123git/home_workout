...
onTap: ()async{
  ...
  if(nameController.text.isNotEmpty &&emailController.text.isNotEmpty && pswrdcontoller.text.isNotEmpty ) {
      ...
      setState(() {
            ...
            Align(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeftWithFade,child: NewLoginPage()));
                },
                child: Text.rich(
                    TextSpan(
                        children: [
                          TextSpan(
                              ...
                              style: TextStyle(fontSize: 16,color: Color(0xff1e1e1e),fontWeight: FontWeight.w600)
                          ),
                    ...
                    TextSpan(
                        children: [
                          TextSpan(
                              ...
                              style: TextStyle(fontSize: 12,color: Color(0xff4a4545),fontWeight: FontWeight.w400)
                          ),
