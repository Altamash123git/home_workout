        ...
        actions: [
          Padding(
            ...
            child: Column(
              ...
              children: [
            Icon(Icons.skip_next_outlined,color: AppColors.secondaryolor,size: 29,weight: 30,),
                Text(
                  "SKIP",
                  style: TextStyle(color: AppColors.secondaryolor, fontSize: 12,fontWeight: FontWeight.w900),
                )
              ],
            ),
          )
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
              ...
              child: Row(
                children: [
                  Expanded(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage("assets/images/male 1.png",),fit: BoxFit.fill)),
                  )),
                  Expanded(
                    flex: 26,
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                                shadows: [
                                  Shadow(offset: Offset(0, 1), blurRadius: 0.1,color: Color(0x7f000000))
                                ],
                              wordSpacing: 2,
                              height: 1.5,
            ...
            Container(
                width: 150,
                child: Text("Let us know about yourself",textAlign: TextAlign.center, style:
                TextStyle(
                    shadows: [
                      Shadow(offset: Offset(0, 0.2), blurRadius: 0.1,color: Color(0x7f000000))
                    ],
                    wordSpacing: 1,
                    fontSize: 13,
                    height: 1.5,
            ...
            InkWell(
              onTap: (){
                Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft,child: NewLoginPage()));
              },
              child: Container(
                alignment: Alignment.center,
                width:150,
